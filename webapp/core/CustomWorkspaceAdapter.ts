...
import CustomerMdiWorkspaceContainer from "./CustomerMdiWorkspaceContainer";
...
export default class CustomWorkspaceAdapter implements WorkspaceAdapter {
  ...
  private readonly tabs: CustomerMdiWorkspaceContainer;
  public constructor(private readonly onWorkspaceChange?: () => void) {
    this.tabs = new CustomerMdiWorkspaceContainer(id => this.activate(id), id => this.close(id));
  }
